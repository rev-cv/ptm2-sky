...
- добавить в RESULT поле `risk` со значением в виде объекта имеющего следующие поля:
- добавить в RESULT поле `risk_explanation` со значением в виде объекта имеющего следующие поля:
